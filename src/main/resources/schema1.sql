...
--    roles varchar(255) NOT NULL CHECK (roles in ('ADMIN','USER')),
...
create table products (product_id bigint generated by default as identity, description varchar(255), image varchar(255), name varchar(255) not null, price numeric(38,2), score float(24), primary key (product_id))
