...
INSERT INTO products (name, price, image_path_fs, description, score)
VALUES ('Смартфон', 34999, 'phone.svg', 'Смартфон нового поколения', 4.32);

INSERT INTO products (name, price, image_path_fs, description, score)
VALUES ('Книга', 999, 'book.svg', 'А.С.Пушкин Евгений Онегин', 5);

INSERT INTO products (name, price, image_path_fs, description, score)
VALUES ('Чайная пара', 3999, 'glass.svg', 'Керамическая кружка и блюдце для чая', 4.24);

INSERT INTO products (name, price, image_path_fs, description, score)
VALUES ('Утюг', 3489, 'iron.svg', 'Утюг - легкий, но отлично гладит', 3.12);

INSERT INTO products (name, price, image_path_fs, description, score)
VALUES ('Дрель', 2588, 'drill.svg', 'Дрель стандартная', 4);

INSERT INTO products (name, price, image_path_fs, description, score)
VALUES ('Игрушка', 858, 'toys.svg', 'Игрушка 3+, материал: безопасный пластик', 4.4);
